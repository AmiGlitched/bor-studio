...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { name: 'Asset Library', href: '/client' },
    { name: 'Content Strategy', href: '/client/ideas' },
    { name: 'Viral Predictor', href: '/client/viral-predictor' },
    { name: 'Strategy Syncs', href: '/client/meetings' },
    { name: 'Shoots & Schedule', href: '/client/shoots' },
  ]
